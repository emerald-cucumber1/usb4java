...
public class UsbAssume {
    ...
    public static void assumeHotplugAvailable() {
        ...
        assumeTrue("This test is ignored because libusb doesn't support hotplug on this system", LibUsb.hasCapability(LibUsb.CAP_HAS_HOTPLUG));
    }
    ...
    public static void assumeTckTestsEnabled() {
        ...
        assumeTrue("This test is ignored when TCK_TESTS property is not set", tckTests);
    }
}
