...
public final class LibUsb {
     ...
     * requirements.
     *
     * @param context The {@link Context} on which to operate.
     ...
     * @param context The {@link Context} on which to operate.
     * @param option  Which option to set.
     * @param value   Required argument for the specified option.
     * @return {@link #SUCCESS} on success, {@link #ERROR_INVALID_PARAM} if the option or arguments are invalid,
     * {@link #ERROR_NOT_SUPPORTED} if the option is valid but not supported on this platform.
     */
     ...
     *
     * @param handle     a device handle
     * @param numStreams number of streams to try to allocate
     ...
     * @param size   The size of the previously allocated memory.
     ...
     * strings.
     * <p>
     * If {@code #setLocale(String)} is not called, all messages will be in
     * English.
     * <p>
     ...
     * @param timeout       Timeout (in milliseconds) that this function should wait before
     ...
     * @param handle   Handle of the device that will handle the transfer.
     * @param endpoint Address of the endpoint where this transfer will be sent.
     * @param streamId Bulk stream id for this transfer.
     * @param buffer   Data buffer.
     * @param callback Callback function to be invoked on transfer completion.
     * @param userData User data to pass to callback function.
     * @param timeout  Timeout for the transfer in milliseconds.
    ...
    static int hotplugCallback(final Context context, final Device device,
        ...
        // map, like when unregistering manually.
        if (result == 1) {
     ...
     */
    @Contract("_, _, _, _, _, _, null, _, _ -> fail")
    public static synchronized int hotplugRegisterCallback(
            ...
            final HotplugCallback callback,
